...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="list-group" style="list-style:none; width:20%;">
        ...
        <li class="list-group-item"><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $team->team_name],
                ['confirm' => __('Are you sure you want to delete # {0}?', $team->team_name)]
            )
        ?></li>
...
<h1 class="page-header" style="width:60%;">Edit Info <?php echo "<br>(".$team->team_name; ?>)</h1>
