...
<?php
 ...
 $percent_played = explode(',',$playerStats->percent_played);
 $hero_percent_played = array_combine($hero_list, $percent_played);
 // var_dump($player);
 $statList = array('elim','death','damage','healing','final_blow');
?>
...
<article>
  ...
  <div class="col-md-2 com-lg-2">
    ...
    <div class='card text-white bg-dark mb-3' style='max-width: 12rem';>
          <div class='card-header text-center ' >Eliminations</div>
          <h4 class='card-title text-center'><?php echo $playerStats->elim; ?></h4>
    </div>

    <div class='card text-white bg-dark mb-3' style='max-width: 12rem';>
          <div class='card-header text-center ' >Deaths</div>
          <h4 class='card-title text-center'><?php echo $playerStats->death; ?></h4>
    </div>

    <div class='card text-white bg-dark mb-3' style='max-width: 12rem';>
          <div class='card-header text-center ' >Damage</div>
          <h4 class='card-title text-center'><?php echo $playerStats->damage; ?></h4>
    </div>

    <div class='card text-white bg-dark mb-3' style='max-width: 12rem';>
          <div class='card-header text-center ' >Healing</div>
          <h4 class='card-title text-center'><?php echo $playerStats->healing; ?></h4>
    </div>

    <div class='card text-white bg-dark mb-3' style='max-width: 12rem';>
          <div class='card-header text-center ' >Final Blows</div>
          <h4 class='card-title text-center'><?php echo $playerStats->final_blow; ?></h4>
    </div>
  </div>
