...
<h1 class="page-header" style="width:60%;">Edit Role <?php echo "<br>(".$user->username; ?>)</h1>

<div class="users form large-9 medium-8 columns content">
    <?= $this->Form->create('User', array('action' => 'editrole/'.$user->username)) ?>
    <fieldset>
        <?php
          echo "<label style=\"font-weight:bold;\">New Role</label><br>";
